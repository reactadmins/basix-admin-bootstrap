...
const OverlayCard = () => {
    return (
        <Card
            className={`${styles.card} rounded-0 rounded-top border-0 w-100 h-100`}
        >
            <Card.Body className={`${styles.card_body} p-0`}>
                <div className={styles.media_container}>
                    <div className={`${styles.twt_mark} rounded-top`}>
                        <i className="fa-brands fa-twitter d-flex justify-content-end p-2 text-light fs-5"></i>
                        <div className={styles.twt_overlay}></div>
                    ...
                    >
                        ...
                        <div
                            className={`${styles.weather_category} text-center`}
                        >
