        ...
        <Fragment>
            <Navbar
                ...
                <Container fluid className="px-4">
                    <Navbar.Collapse className={`${navbarStyle.collapse} justify-content-between`}>
                        ...
                        <div className={navbarStyle.search_container}>
                            <button type="button" className={navbarStyle.search_btn}>
                        ...
                        <Nav>
                            <ul className={navbarStyle.social_item} ref={dropRef}>
                                <li>
                                    <DarkModeSwitch />
                                </li>
                                <li>
                                    <button
                                        ...
                                        <span className={`${navbarStyle.count}  bg-danger`}>5</span>
                                    </button>
                                    {!openNotification ? (
                                ...
                                <li>
                                    <button
                                        ...
                                        <span className={`${navbarStyle.count} bg-primary`}>5</span>
                                    </button>
                                    {!openMessage ? (
                                        <DropdownMenu left="24px" right="24px">
                                            <Message />
                ...
                <div
                    ...
                    className={`${navbarStyle.duall_navbar} ${navbarStyle[topNavbarBgColor]} ${
                    ...
                    <ul className={`${navbarStyle.nav} nav navbar-nav`}>
                        {navItems?.map((item, index) => (
                            <li
                                key={index}
                                className={`${navbarStyle.nav_item} ${item.title ? "d-none" : ""}`}>
                                {(item?.path && (
                                    <Fragment>
                                ...
                                {item.children ? (
                                    <ul className={navbarStyle.sub_menu}>
                                        {item?.children?.map((childItem, index) => (
                                            <li key={index} className={navbarStyle.nav_item}>
                                                <Link
                                                    to={childItem?.path}
                                                    className="d-flex justify-content-between align-items-center">
                                                    <div className="d-flex align-items-center">
