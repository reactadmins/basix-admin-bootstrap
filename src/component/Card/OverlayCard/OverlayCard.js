...
const OverlayCard = () => {
  return (
    <div className="card">
      <div
        className="twt-mark rounded-top"
        style={{ background: "#58C9F3", padding: "10px 10px 20px 10px" }}
      >
        <i className="fa-brands fa-twitter d-flex justify-content-end p-2 text-light fs-5"></i>
        <div className="twt-overlay"></div>
      ...
      <div className="py-3 d-flex justify-content-center gap-5">
        ...
        <div
          className="weather-category text-center"
          style={{ color: " #bdbdbd", fontSize: "13px" }}
        >
          <span>865</span>
      ...
      <div className="px-3 py-3">
        ...
        <div className="mt-2 d-flex justify-content-between">
          <div>
            ...
            <span className="text-secondary" style={{ color: "#d2d2d2" }}>
              New Castle, UK
            </span>
          </div>
