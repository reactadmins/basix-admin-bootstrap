                            ...
                            <div className="mb-4 px-4">
                                <div className="row">
                                    <div className="col-4 text-center">
                                        <span style={{ color: "#868e96", fontSize: "14px" }}>Visits</span>
                                        <h4 className="m-0 text-up pb-1" style={{ fontSize: "1.1rem" }}>
                                            29.703 Users (40%)
                                        </h4>
                                        <div className="progress" style={{ backgroundColor: "#e9ecef", height: "5px" }}>
                                            <div
                                                ...
                                                aria-valuemin="0"
                                                aria-valuemax="100"
                                                style={{ width: "40%", backgroundColor: "#28a745" }}></div>
                                        </div>
                                    </div>
                                    <div className="col-4 text-center">
                                        <span style={{ color: "#868e96", fontSize: "14px" }}>Visits</span>
                ...
                <div className="col-12 col-md-12 col-lg-8 col-xl-8 mb-4">
                    ...
                    <div className="row mt-4">
                        <div className="col-md-4 col-lg-4 col-xl-4">
                            <div className="mb-4 mb-md-0">
                                <SocialMediaCounter icon="fa-brands fa-twitter" iconBg="#1da1f2" count="1875980" />
                            </div>
                        </div>
                        <div className="col-md-4 col-lg-4 col-xl-4 ">
                            <div className="mb-4 mb-md-0">
                                <SocialMediaCounter icon="fa-brands fa-facebook-f" iconBg="#3B5998" count="1875980" />
                            </div>
                        </div>
                        <div className="col-md-4 col-lg-4 col-xl-4 ">
                            <div className="mb-4 mb-md-0">
                                <SocialMediaCounter icon="fa-brands fa-instagram" iconBg="#833AB4" count="1875980" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <Card
                        ...
                        cardFooter={
                            <div className="row" style={{ padding: "35px 30px 24px 30px" }}>
                                <div className="col-4">
                                    <CartDataCount chadtColor="bounce-rate" countName="Bounce Rate"></CartDataCount>
                                </div>
                                <div className="col-4">
                                    <CartDataCount chadtColor="pageviews" countName="Pageviews"></CartDataCount>
                                </div>
                                <div className="col-4">
                                    <CartDataCount chadtColor="new-users" countName="New Users"></CartDataCount>
                                </div>
                            </div>
                        }></Card>
                </div>
