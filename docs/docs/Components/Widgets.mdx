...
<FeatureTable>
    <tr>
        <td>type</td>
        <td>
            `revenue-counter` | `user-info` | `revenue-progressBar` |
            `revenue-earning`
        </td>
        <td>`revenue-counter`</td>
        <td>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla
            dolore perferendis voluptatum natus provident libero quas at, rem
            modi impedit autem, magni ex porro temporibus cupiditate expedita
            aliquid tempore fugiat?
        </td>
    </tr>
    <tr>
        <td>bgColor</td>
