...
<FeatureTable>
    <tr>
        ...
        <td>string</td>
        <td></td>
        <td>A string that specifies the key of the active tab. You can use this prop to control which tab is selected by default or by the user. For example, `activeTab="home"`.</td>
    </tr>
    <tr>
        <td>tabPosition</td>
